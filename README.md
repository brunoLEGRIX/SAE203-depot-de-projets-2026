...
- Le contenu du répertoire [**depot/EquipeX/**](https://github.com/brunoLEGRIX/depot-de-projets-SAE203-2026/tree/master/depot/EquipeX) peut servir de modèle pour remplir le ```README.md``` respectif de votre équipe.
...
- Une fois les pull-requests de toutes les équipes complétés, la structure du répertoire [**depot**](https://github.com/brunoLEGRIX/depot-de-projets-SAE203-2026/tree/master/depot) devrait être la suivante : 
